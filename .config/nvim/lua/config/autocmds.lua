...
-- personal
-- ===============================
-- disable spell checking but enable wrapping for markup languages
...
-- stop nvim from automatically inserting comment leaders when hitting enter
vim.api.nvim_create_autocmd("FileType", {
  group = augroup("no_comment_leader"),
  pattern = "*",
  callback = function()
...
-- force python files to use 2 spaces instead of the standard 4
vim.api.nvim_create_autocmd("FileType", {
